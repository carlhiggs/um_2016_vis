...
server <- function(input, output) {
  ...
  groupNames <- c(
                  paste0("<span style='color: #000000; font-size: 11pt'><strong>Total</strong></span>"),
  ...
  output$map <- renderLeaflet({
   ...
   #            ) %>%
    ...
    addEsriTiledMapLayer('https://geo.abs.gov.au/arcgis/rest/services/ASGS2016/UCL/MapServer',group=overlay[1]) %>%
    addEsriTiledMapLayer('https://geo.abs.gov.au/arcgis/rest/services/ASGS2016/SUA/MapServer',group=overlay[2]) %>%
