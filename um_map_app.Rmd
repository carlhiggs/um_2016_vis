...
server <- function(input, output) {
  ...
  output$barplot=renderPlot({
    ...
    if(is.null(area_of_interest)){
        ...
        barplot(as.numeric(um_2016_overall[,c('peranytree_public_total','peranytree_private_total','peranytree_other_total')]) ,
                horiz=TRUE,
                xlim = c(0,100),
                ...
                title(paste0("Tree area percent of ",toupper('area_id'),"s, by land status."), line=2, adj=0)
    }else{
        par(mai=c(1.02,left_inches,0.82,0.42))
...
ui <- fluidPage(
  ...
  column(4,plotOutput("pieplot", width="300px"),plotOutput("barplot", width="300px")),
  br()
)
