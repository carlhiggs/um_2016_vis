...
output$map <-  renderLeaflet({
  ...
  pal <- colorNumeric(palette = "RdYlGn", domain = active_data()$estimated_population)
...
ui <- fluidPage(
  ...
  column(4,plotOutput("barplot", height ="200px",width="300px"),plotOutput("pieplot", width="300px")),
  br()
)
